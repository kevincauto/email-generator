...
export const cdew_lab_initial_state = [
                        ...
                        <td align="center"><table cellpadding="0" cellspacing="0" border="0" width="100%">
                            <tr>
                              <td align="center"><table cellpadding="0" cellspacing="0" border="0" width="100%" bgcolor="#2f84c0">
                                  <tr>
                                    <td align="center" class="f12" height="50" valign="middle" style="font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:18px; color:#ffffff; padding-left:20px;"><span class="white">${monthName} ${year} </span> | <span class="white1"> <a href="http://www.cdeworld.com" target="_blank" style="color:#ffffff;">Visit Our Website</a></span> | <span class="white1"><a href="http://aegispublications.com/news/ce/${year}/${month}/ce2.html" target="_blank" style="color:#ffffff;">Read Online</a></span> | <span class="white1"><a href="mailto:?subject=FW: Lab Technicians News&amp;body=I thought you might be interested in this: http://aegispublications.com/news/ce/${year}/${month}/ce2.html" target="_blank" style="color:#ffffff;">Forward&nbsp;to&nbsp;a&nbsp;Colleague</a></span></td>
                            ...
                            <tr>
                              <td align="center" bgcolor="#2469AA"><table align="center" width="100%">
                                  <tr>
                                    <td align="center" height="30" style="font-family:Arial, Helvetica, sans-serif; font-size:15px; line-height:18px; color:#fffff;border-right:1px solid #315D86; text-transform:uppercase;" class="menu"><span class="white"><a href="https://cdeworld.com/courses/search?utf8=%E2%9C%93&q=&c=314&p=&o=&s=&commit=SEARCH" target="_blank" style=" color:#ffffff; text-decoration:none;">Courses</a></span></td>
                                    ...
                                    <td align="center" height="30" style="font-family:Arial, Helvetica, sans-serif; font-size:15px; line-height:18px; color:#fffff;border-right:1px solid #315D86; text-transform:uppercase;" class="menu"><span class="white"><a href="https://cdeworld.com/webinars/search?c=314" target="_blank" style=" color: #ffffff;text-decoration:none;">Webinars</a></span></td>
                            ...
                            <tr>
                              <td align="center" class="f26" style="font-family:Arial, Helvetica, sans-serif; font-size:21px; line-height:30px; font-weight:bold; color:#333333; padding-bottom:10px;">New CE Opportunities for Lab Technicians | ${monthName} ${year}</td>
                            </tr>
                            <tr>
