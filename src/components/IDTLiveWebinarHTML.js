...
export default class IDTLiveWebinarHTML extends React.Component {
    render() {
        const { lyrisName='', title, date, provider, supporter, cost, credits, description, lo1, lo2, lo3, presenter, link, tvLink, unsubscribe, disclosure } = this.props.info[this.props.info.selected_template];
        let html;
